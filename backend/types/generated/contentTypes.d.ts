...
export interface ApiPersonalProjectPersonalProject
  extends Struct.CollectionTypeSchema {
  collectionName: 'personal_projects';
  info: {
    displayName: 'Personal-Project';
    pluralName: 'personal-projects';
    singularName: 'personal-project';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::personal-project.personal-project'
    > &
      Schema.Attribute.Private;
...
export interface ApiWorkExperienceWorkExperience
  ...
  attributes: {
    BulletPoints: Schema.Attribute.JSON & Schema.Attribute.Required;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WorkID: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::personal-project.personal-project': ApiPersonalProjectPersonalProject;
